...
extern "C" cudaError_t cudaDeviceGetTexture1DLinearMaxWidth(size_t *maxWidthInElements, const struct cudaChannelFormatDesc *fmtDesc, int device) {
    ...
    void *_0fmtDesc = mem2server((void *)fmtDesc, sizeof(*fmtDesc));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    mem2client((void *)fmtDesc, sizeof(*fmtDesc));
    return _result;
}
...
extern "C" cudaError_t cudaDeviceGetCacheConfig(enum cudaFuncCache *pCacheConfig) {
...
#endif
    void *_0pCacheConfig = mem2server((void *)pCacheConfig, sizeof(*pCacheConfig));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pCacheConfig, sizeof(*pCacheConfig));
    return _result;
}
...
extern "C" cudaError_t cudaIpcOpenEventHandle(cudaEvent_t *event, cudaIpcEventHandle_t handle) {
...
#endif
    void *_0event = mem2server((void *)event, sizeof(*event));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)event, sizeof(*event));
    return _result;
}
...
extern "C" cudaError_t cudaDeviceGetDefaultMemPool(cudaMemPool_t *memPool, int device) {
...
#endif
    void *_0memPool = mem2server((void *)memPool, sizeof(*memPool));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)memPool, sizeof(*memPool));
    return _result;
}
...
extern "C" cudaError_t cudaSetValidDevices(int *device_arr, int len) {
...
#endif
    void *_0device_arr = mem2server((void *)device_arr, sizeof(*device_arr));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)device_arr, sizeof(*device_arr));
    return _result;
}
...
extern "C" cudaError_t cudaStreamCreate(cudaStream_t *pStream) {
...
#endif
    void *_0pStream = mem2server((void *)pStream, sizeof(*pStream));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pStream, sizeof(*pStream));
    return _result;
}
...
extern "C" cudaError_t cudaStreamEndCapture(cudaStream_t stream, cudaGraph_t *pGraph) {
...
#endif
    void *_0pGraph = mem2server((void *)pGraph, sizeof(*pGraph));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pGraph, sizeof(*pGraph));
    return _result;
}
...
extern "C" cudaError_t cudaStreamIsCapturing(cudaStream_t stream, enum cudaStreamCaptureStatus *pCaptureStatus) {
...
#endif
    void *_0pCaptureStatus = mem2server((void *)pCaptureStatus, sizeof(*pCaptureStatus));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pCaptureStatus, sizeof(*pCaptureStatus));
    return _result;
}
...
extern "C" cudaError_t cudaStreamGetCaptureInfo(cudaStream_t stream, enum cudaStreamCaptureStatus *pCaptureStatus, unsigned long long *pId) {
...
#endif
    void *_0pCaptureStatus = mem2server((void *)pCaptureStatus, sizeof(*pCaptureStatus));
    void *_0pId = mem2server((void *)pId, sizeof(*pId));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pCaptureStatus, sizeof(*pCaptureStatus));
    mem2client((void *)pId, sizeof(*pId));
    return _result;
}
...
#endif
    void *_0ms = mem2server((void *)ms, sizeof(*ms));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cudaError_t cudaImportExternalMemory(cudaExternalMemory_t *extMem_out, const struct cudaExternalMemoryHandleDesc *memHandleDesc) {
...
#endif
    void *_0extMem_out = mem2server((void *)extMem_out, sizeof(*extMem_out));
    void *_0memHandleDesc = mem2server((void *)memHandleDesc, sizeof(*memHandleDesc));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)extMem_out, sizeof(*extMem_out));
    mem2client((void *)memHandleDesc, sizeof(*memHandleDesc));
    return _result;
}
...
extern "C" cudaError_t cudaExternalMemoryGetMappedBuffer(void **devPtr, cudaExternalMemory_t extMem, const struct cudaExternalMemoryBufferDesc *bufferDesc) {
...
#endif
    // PARAM void **devPtr
    void *_0bufferDesc = mem2server((void *)bufferDesc, sizeof(*bufferDesc));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    // PARAM void **devPtr
    mem2client((void *)bufferDesc, sizeof(*bufferDesc));
    return _result;
}
...
extern "C" cudaError_t cudaFuncGetAttributes(struct cudaFuncAttributes *attr, const void *func) {
...
#endif
    void *_0attr = mem2server((void *)attr, sizeof(*attr));
    void *_0func = mem2server((void *)func, 0);
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
    ...
    rpc_free_client(client);
    mem2client((void *)attr, sizeof(*attr));
    mem2client((void *)func, 0);
    return _result;
}
...
#endif
    void *_0d = mem2server((void *)d, sizeof(*d));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cudaError_t cudaMallocArray(cudaArray_t *array, const struct cudaChannelFormatDesc *desc, size_t width, size_t height, unsigned int flags) {
...
#endif
    void *_0array = mem2server((void *)array, sizeof(*array));
    ...
    rpc_free_client(client);
    mem2client((void *)array, sizeof(*array));
...
extern "C" cudaError_t cudaMallocMipmappedArray(cudaMipmappedArray_t *mipmappedArray, const struct cudaChannelFormatDesc *desc, struct cudaExtent extent, unsigned int numLevels, unsigned int flags) {
...
#endif
    void *_0mipmappedArray = mem2server((void *)mipmappedArray, sizeof(*mipmappedArray));
    void *_0desc = mem2server((void *)desc, sizeof(*desc));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
    ...
    rpc_free_client(client);
    mem2client((void *)mipmappedArray, sizeof(*mipmappedArray));
    mem2client((void *)desc, sizeof(*desc));
    return _result;
}
...
extern "C" cudaError_t cudaGetMipmappedArrayLevel(cudaArray_t *levelArray, cudaMipmappedArray_const_t mipmappedArray, unsigned int level) {
...
#endif
    void *_0levelArray = mem2server((void *)levelArray, sizeof(*levelArray));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)levelArray, sizeof(*levelArray));
    return _result;
}
...
#endif
    void *_0p = mem2server((void *)p, sizeof(*p));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cudaError_t cudaArrayGetInfo(struct cudaChannelFormatDesc *desc, struct cudaExtent *extent, unsigned int *flags, cudaArray_t array) {
...
#endif
    void *_0desc = mem2server((void *)desc, sizeof(*desc));
    void *_0extent = mem2server((void *)extent, sizeof(*extent));
    void *_0flags = mem2server((void *)flags, sizeof(*flags));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
    ...
    rpc_free_client(client);
    mem2client((void *)desc, sizeof(*desc));
    mem2client((void *)extent, sizeof(*extent));
    mem2client((void *)flags, sizeof(*flags));
    return _result;
}
...
extern "C" cudaError_t cudaMemcpy2D(void *dst, size_t dpitch, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind) {
...
#endif
    void *_0dst = mem2server((void *)dst, dpitch * height);
    void *_0src = mem2server((void *)src, spitch * height);
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)dst, dpitch * height);
    mem2client((void *)src, spitch * height);
    return _result;
}
...
extern "C" cudaError_t cudaMemPoolSetAccess(cudaMemPool_t memPool, const struct cudaMemAccessDesc *descList, size_t count) {
...
#endif
    void *_0descList = mem2server((void *)descList, sizeof(*descList));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)descList, sizeof(*descList));
    return _result;
}
...
extern "C" cudaError_t cudaMemPoolExportPointer(struct cudaMemPoolPtrExportData *exportData, void *ptr) {
...
#endif
    void *_0exportData = mem2server((void *)exportData, sizeof(*exportData));
    void *_0ptr = mem2server((void *)ptr, 0);
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
    ...
    rpc_free_client(client);
    mem2client((void *)exportData, sizeof(*exportData));
    mem2client((void *)ptr, 0);
    return _result;
}
...
extern "C" cudaError_t cudaBindSurfaceToArray(const struct surfaceReference *surfref, cudaArray_const_t array, const struct cudaChannelFormatDesc *desc) {
...
#endif
    void *_0surfref = mem2server((void *)surfref, sizeof(*surfref));
    void *_0desc = mem2server((void *)desc, sizeof(*desc));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
    ...
    rpc_free_client(client);
    mem2client((void *)surfref, sizeof(*surfref));
    mem2client((void *)desc, sizeof(*desc));
    return _result;
}
...
extern "C" cudaError_t cudaRuntimeGetVersion(int *runtimeVersion) {
...
#endif
    void *_0runtimeVersion = mem2server((void *)runtimeVersion, sizeof(*runtimeVersion));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)runtimeVersion, sizeof(*runtimeVersion));
    return _result;
}
...
extern "C" cudaError_t cudaGraphAddKernelNode(cudaGraphNode_t *pGraphNode, cudaGraph_t graph, const cudaGraphNode_t *pDependencies, size_t numDependencies, const struct cudaKernelNodeParams *pNodeParams) {
...
#endif
    void *_0pGraphNode = mem2server((void *)pGraphNode, sizeof(*pGraphNode));
    void *_0pDependencies = mem2server((void *)pDependencies, sizeof(*pDependencies));
    void *_0pNodeParams = mem2server((void *)pNodeParams, sizeof(*pNodeParams));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pGraphNode, sizeof(*pGraphNode));
    mem2client((void *)pDependencies, sizeof(*pDependencies));
    mem2client((void *)pNodeParams, sizeof(*pNodeParams));
    return _result;
}
...
extern "C" cudaError_t cudaGraphAddMemcpyNode(cudaGraphNode_t *pGraphNode, cudaGraph_t graph, const cudaGraphNode_t *pDependencies, size_t numDependencies, const struct cudaMemcpy3DParms *pCopyParams) {
    ...
    void *_0pGraphNode = mem2server((void *)pGraphNode, sizeof(*pGraphNode));
    void *_0pDependencies = mem2server((void *)pDependencies, sizeof(*pDependencies));
    void *_0pCopyParams = mem2server((void *)pCopyParams, sizeof(*pCopyParams));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    mem2client((void *)pGraphNode, sizeof(*pGraphNode));
    mem2client((void *)pDependencies, sizeof(*pDependencies));
    mem2client((void *)pCopyParams, sizeof(*pCopyParams));
    return _result;
}
...
extern "C" cudaError_t cudaGraphAddMemsetNode(cudaGraphNode_t *pGraphNode, cudaGraph_t graph, const cudaGraphNode_t *pDependencies, size_t numDependencies, const struct cudaMemsetParams *pMemsetParams) {
    ...
    void *_0pGraphNode = mem2server((void *)pGraphNode, sizeof(*pGraphNode));
    void *_0pDependencies = mem2server((void *)pDependencies, sizeof(*pDependencies));
    void *_0pMemsetParams = mem2server((void *)pMemsetParams, sizeof(*pMemsetParams));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    mem2client((void *)pGraphNode, sizeof(*pGraphNode));
    mem2client((void *)pDependencies, sizeof(*pDependencies));
    mem2client((void *)pMemsetParams, sizeof(*pMemsetParams));
    return _result;
}
...
extern "C" cudaError_t cudaGraphClone(cudaGraph_t *pGraphClone, cudaGraph_t originalGraph) {
...
#endif
    void *_0pGraphClone = mem2server((void *)pGraphClone, sizeof(*pGraphClone));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pGraphClone, sizeof(*pGraphClone));
    return _result;
}
...
extern "C" cudaError_t cudaGraphNodeFindInClone(cudaGraphNode_t *pNode, cudaGraphNode_t originalNode, cudaGraph_t clonedGraph) {
...
#endif
    void *_0pNode = mem2server((void *)pNode, sizeof(*pNode));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pNode, sizeof(*pNode));
    return _result;
}
...
extern "C" cudaError_t cudaGraphNodeGetType(cudaGraphNode_t node, enum cudaGraphNodeType *pType) {
...
#endif
    void *_0pType = mem2server((void *)pType, sizeof(*pType));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pType, sizeof(*pType));
    return _result;
}
...
extern "C" cudaError_t cudaGraphGetRootNodes(cudaGraph_t graph, cudaGraphNode_t *pRootNodes, size_t *pNumRootNodes) {
...
#endif
    void *_0pRootNodes = mem2server((void *)pRootNodes, sizeof(*pRootNodes));
    void *_0pNumRootNodes = mem2server((void *)pNumRootNodes, sizeof(*pNumRootNodes));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pRootNodes, sizeof(*pRootNodes));
    mem2client((void *)pNumRootNodes, sizeof(*pNumRootNodes));
    return _result;
}
...
extern "C" cudaError_t cudaGraphNodeGetDependencies(cudaGraphNode_t node, cudaGraphNode_t *pDependencies, size_t *pNumDependencies) {
...
#endif
    void *_0pDependencies = mem2server((void *)pDependencies, sizeof(*pDependencies));
    void *_0pNumDependencies = mem2server((void *)pNumDependencies, sizeof(*pNumDependencies));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pDependencies, sizeof(*pDependencies));
    mem2client((void *)pNumDependencies, sizeof(*pNumDependencies));
    return _result;
}
...
extern "C" cudaError_t cudaGraphNodeGetDependentNodes(cudaGraphNode_t node, cudaGraphNode_t *pDependentNodes, size_t *pNumDependentNodes) {
...
#endif
    void *_0pDependentNodes = mem2server((void *)pDependentNodes, sizeof(*pDependentNodes));
    void *_0pNumDependentNodes = mem2server((void *)pNumDependentNodes, sizeof(*pNumDependentNodes));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pDependentNodes, sizeof(*pDependentNodes));
    mem2client((void *)pNumDependentNodes, sizeof(*pNumDependentNodes));
    return _result;
}
...
extern "C" cudaError_t cudaGraphInstantiate(cudaGraphExec_t *pGraphExec, cudaGraph_t graph, cudaGraphNode_t *pErrorNode, char *pLogBuffer, size_t bufferSize) {
...
#endif
    void *_0pGraphExec = mem2server((void *)pGraphExec, sizeof(*pGraphExec));
    void *_0pErrorNode = mem2server((void *)pErrorNode, sizeof(*pErrorNode));
    cudaError_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
    ...
    rpc_free_client(client);
    mem2client((void *)pGraphExec, sizeof(*pGraphExec));
    mem2client((void *)pErrorNode, sizeof(*pErrorNode));
    return _result;
}
...
extern "C" cudaError_t cudaGetFuncBySymbol(cudaFunction_t *functionPtr, const void *symbolPtr) {
...
#endif
    void *_0functionPtr = mem2server((void *)functionPtr, sizeof(*functionPtr));
    ...
    rpc_free_client(client);
    mem2client((void *)functionPtr, sizeof(*functionPtr));
