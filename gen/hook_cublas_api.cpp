...
#endif
    void *_0streamId = mem2server((void *)streamId, sizeof(*streamId));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0smCountTarget = mem2server((void *)smCountTarget, sizeof(*smCountTarget));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0userCallback = mem2server((void *)userCallback, sizeof(*userCallback));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0x = mem2server((void *)x, n * elemSize);
    void *_0y = mem2server((void *)y, n * elemSize);
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0A = mem2server((void *)A, rows * cols * elemSize);
    void *_0B = mem2server((void *)B, rows * cols * elemSize);
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0x = mem2server((void *)x, n * sizeofType(xType));
    void *_0result = mem2server((void *)result, sizeofType(resultType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    void *_0result = mem2server((void *)result, sizeof(*result));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0x = mem2server((void *)x, n * sizeofType(xType));
    void *_0y = mem2server((void *)y, n * sizeofType(yType));
    void *_0result = mem2server((void *)result, sizeofType(resultType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    void *_0y = mem2server((void *)y, n * sizeof(*y));
    void *_0result = mem2server((void *)result, sizeof(*result));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeofType(alphaType));
    void *_0x = mem2server((void *)x, n * sizeofType(xType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
extern "C" cublasStatus_t cublasSrot_v2(cublasHandle_t handle, int n, float *x, int incx, float *y, int incy, const float *c, const float *s) {
    ...
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    void *_0y = mem2server((void *)y, n * sizeof(*y));
    void *_0c = mem2server((void *)c, sizeof(*c));
    void *_0s = mem2server((void *)s, sizeof(*s));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cublasStatus_t cublasRotEx(cublasHandle_t handle, int n, void *x, cudaDataType xType, int incx, void *y, cudaDataType yType, int incy, const void *c, const void *s, cudaDataType csType, cudaDataType executiontype) {
    ...
    void *_0x = mem2server((void *)x, n * sizeofType(xType));
    void *_0y = mem2server((void *)y, n * sizeofType(yType));
    void *_0c = mem2server((void *)c, sizeofType(csType));
    void *_0s = mem2server((void *)s, sizeofType(csType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0a = mem2server((void *)a, sizeof(*a));
    void *_0b = mem2server((void *)b, sizeof(*b));
    void *_0c = mem2server((void *)c, sizeof(*c));
    void *_0s = mem2server((void *)s, sizeof(*s));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
#endif
    void *_0a = mem2server((void *)a, sizeofType(abType));
    void *_0b = mem2server((void *)b, sizeofType(abType));
    void *_0c = mem2server((void *)c, sizeofType(csType));
    void *_0s = mem2server((void *)s, sizeofType(csType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
extern "C" cublasStatus_t cublasSrotm_v2(cublasHandle_t handle, int n, float *x, int incx, float *y, int incy, const float *param) {
    ...
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    void *_0y = mem2server((void *)y, n * sizeof(*y));
    void *_0param = mem2server((void *)param, 5 * sizeof(*param));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cublasStatus_t cublasRotmEx(cublasHandle_t handle, int n, void *x, cudaDataType xType, int incx, void *y, cudaDataType yType, int incy, const void *param, cudaDataType paramType, cudaDataType executiontype) {
    ...
    void *_0x = mem2server((void *)x, n * sizeofType(xType));
    void *_0y = mem2server((void *)y, n * sizeofType(yType));
    void *_0param = mem2server((void *)param, 5 * sizeofType(paramType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0d1 = mem2server((void *)d1, sizeof(*d1));
    void *_0d2 = mem2server((void *)d2, sizeof(*d2));
    void *_0x1 = mem2server((void *)x1, sizeof(*x1));
    void *_0y1 = mem2server((void *)y1, sizeof(*y1));
    void *_0param = mem2server((void *)param, 5 * sizeof(*param));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0d1 = mem2server((void *)d1, sizeofType(d1Type));
    void *_0d2 = mem2server((void *)d2, sizeofType(d2Type));
    void *_0x1 = mem2server((void *)x1, sizeofType(x1Type));
    void *_0y1 = mem2server((void *)y1, sizeofType(y1Type));
    void *_0param = mem2server((void *)param, 5 * sizeofType(paramType));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, m * n * sizeof(*A));
    void *_0x = mem2server((void *)x, (trans == CUBLAS_OP_N ? n : m) * sizeof(*x));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0y = mem2server((void *)y, (trans == CUBLAS_OP_N ? m : n) * sizeof(*y));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cublasStatus_t cublasSgbmv_v2(cublasHandle_t handle, cublasOperation_t trans, int m, int n, int kl, int ku, const float *alpha, const float *A, int lda, const float *x, int incx, const float *beta, float *y, int incy) {
    ...
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0y = mem2server((void *)y, m * sizeof(*y));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0A = mem2server((void *)A, n * n * sizeof(*A));
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0A = mem2server((void *)A, n * k * sizeof(*A));
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0AP = mem2server((void *)AP, (n * (n + 1)) / 2 * sizeof(*AP));
    void *_0x = mem2server((void *)x, n * sizeof(*x));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0x = mem2server((void *)x, m * sizeof(*x));
    void *_0y = mem2server((void *)y, n * sizeof(*y));
    void *_0A = mem2server((void *)A, m * n * sizeof(*A));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, transa == CUBLAS_OP_N ? m * k : k * m * sizeof(*A));
    void *_0B = mem2server((void *)B, transb == CUBLAS_OP_N ? k * n : n * k * sizeof(*B));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, m * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, transa == CUBLAS_OP_N ? m * k : k * m * sizeofType(Atype));
    void *_0B = mem2server((void *)B, transb == CUBLAS_OP_N ? k * n : n * k * sizeofType(Btype));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, m * n * sizeofType(Ctype));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, trans == CUBLAS_OP_N ? n * k : k * n * sizeof(*A));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, n * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, trans == CUBLAS_OP_N ? n * k : k * n * sizeofType(Atype));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, n * n * sizeofType(Ctype));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
extern "C" cublasStatus_t cublasSsyr2k_v2(cublasHandle_t handle, cublasFillMode_t uplo, cublasOperation_t trans, int n, int k, const float *alpha, const float *A, int lda, const float *B, int ldb, const float *beta, float *C, int ldc) {
    ...
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, trans == CUBLAS_OP_N ? n * k : k * n * sizeof(*A));
    void *_0B = mem2server((void *)B, trans == CUBLAS_OP_N ? n * k : k * n * sizeof(*B));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, n * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
extern "C" cublasStatus_t cublasZherkx(cublasHandle_t handle, cublasFillMode_t uplo, cublasOperation_t trans, int n, int k, const cuDoubleComplex *alpha, const cuDoubleComplex *A, int lda, const cuDoubleComplex *B, int ldb, const double *beta, cuDoubleComplex *C, int ldc) {
    ...
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, n * k * sizeof(*A));
    void *_0B = mem2server((void *)B, n * k * sizeof(*B));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, n * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, (side == CUBLAS_SIDE_LEFT ? m * m : n * n) * sizeof(*A));
    void *_0B = mem2server((void *)B, m * n * sizeof(*B));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, m * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
#endif
    void *_0alpha = mem2server((void *)alpha, sizeof(*alpha));
    void *_0A = mem2server((void *)A, m * k * sizeof(*A));
    void *_0B = mem2server((void *)B, k * n * sizeof(*B));
    void *_0beta = mem2server((void *)beta, sizeof(*beta));
    void *_0C = mem2server((void *)C, m * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
...
#endif
    void *_0P = mem2server((void *)P, n * sizeof(*P));
...
#endif
    void *_0devIpiv = mem2server((void *)devIpiv, sizeof(*devIpiv));
    void *_0info = mem2server((void *)info, sizeof(*info));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
...
#endif
    void *_0info = mem2server((void *)info, sizeof(*info));
    void *_0devInfoArray = mem2server((void *)devInfoArray, sizeof(*devInfoArray));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
        std::cerr << "Failed to get rpc client" << std::endl;
...
#endif
    void *_0A = mem2server((void *)A, m * n * sizeof(*A));
    void *_0x = mem2server((void *)x, (mode == CUBLAS_SIDE_LEFT ? m : n) * sizeof(*x));
    void *_0C = mem2server((void *)C, m * n * sizeof(*C));
    cublasStatus_t _result;
    RpcClient *client = rpc_get_client();
    if(client == nullptr) {
