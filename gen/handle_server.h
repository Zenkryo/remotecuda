...
int handle_cuLogsRegisterCallback(void *args);
int handle_cuLogsUnregisterCallback(void *args);
int handle_cuLogsCurrent(void *args);
int handle_cuLogsDumpToFile(void *args);
int handle_cuLogsDumpToMemory(void *args);
...
int handle_nvmlDeviceGetHandleByUUIDV(void *args);
...
int handle_nvmlSystemEventSetCreate(void *args);
int handle_nvmlSystemEventSetFree(void *args);
int handle_nvmlSystemRegisterEvents(void *args);
int handle_nvmlSystemEventSetWait(void *args);
...
int handle_nvmlGpuInstanceGetCreatableVgpus(void *args);
int handle_nvmlVgpuTypeGetMaxInstancesPerGpuInstance(void *args);
int handle_nvmlGpuInstanceGetActiveVgpus(void *args);
int handle_nvmlGpuInstanceSetVgpuSchedulerState(void *args);
int handle_nvmlGpuInstanceGetVgpuSchedulerState(void *args);
int handle_nvmlGpuInstanceGetVgpuSchedulerLog(void *args);
int handle_nvmlGpuInstanceGetVgpuTypeCreatablePlacements(void *args);
int handle_nvmlGpuInstanceGetVgpuHeterogeneousMode(void *args);
int handle_nvmlGpuInstanceSetVgpuHeterogeneousMode(void *args);
...
int handle_cublasGetEmulationStrategy(void *args);
int handle_cublasSetEmulationStrategy(void *args);
