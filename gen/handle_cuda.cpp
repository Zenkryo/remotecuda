...
int handle_cuDeviceGetUuid(void *args0) {
    ...
    rpc_write(client, &uuid, sizeof(uuid));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDeviceGetLuid(void *args0) {
    ...
    rpc_write(client, &deviceNodeMask, sizeof(deviceNodeMask));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDeviceGetDefaultMemPool(void *args0) {
    ...
    rpc_write(client, &pool_out, sizeof(pool_out));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDevicePrimaryCtxRetain(void *args0) {
    ...
    rpc_write(client, &pctx, sizeof(pctx));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDevicePrimaryCtxGetState(void *args0) {
    ...
    rpc_write(client, &active, sizeof(active));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuCtxCreate_v4(void *args0) {
    ...
    rpc_write(client, &pctx, sizeof(pctx));
    rpc_write(client, &ctxCreateParams, sizeof(ctxCreateParams));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuCtxGetId(void *args0) {
    ...
    rpc_write(client, &ctxId, sizeof(ctxId));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuCtxGetExecAffinity(void *args0) {
    ...
    rpc_write(client, &pExecAffinity, sizeof(pExecAffinity));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuModuleLoad(void *args0) {
    ...
    rpc_write(client, &module, sizeof(module));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuModuleLoadDataEx(void *args0) {
    ...
    rpc_write(client, &module, sizeof(module));
    rpc_write(client, &options, sizeof(options));
    // PARAM void **optionValues
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
...
int handle_cuModuleEnumerateFunctions(void *args0) {
    ...
    rpc_write(client, &functions, sizeof(functions));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuLinkCreate_v2(void *args0) {
    ...
    rpc_write(client, &options, sizeof(options));
    // PARAM void **optionValues
    rpc_write(client, &stateOut, sizeof(stateOut));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuLinkComplete(void *args0) {
    ...
    // PARAM void **cubinOut
    rpc_write(client, &sizeOut, sizeof(sizeOut));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuModuleGetTexRef(void *args0) {
    ...
    rpc_write(client, &pTexRef, sizeof(pTexRef));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuModuleGetSurfRef(void *args0) {
    ...
    rpc_write(client, &pSurfRef, sizeof(pSurfRef));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuLibraryGetModule(void *args0) {
    ...
    rpc_write(client, &pMod, sizeof(pMod));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuKernelGetFunction(void *args0) {
    ...
    rpc_write(client, &pFunc, sizeof(pFunc));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuKernelGetLibrary(void *args0) {
    ...
    rpc_write(client, &pLib, sizeof(pLib));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuIpcGetEventHandle(void *args0) {
    ...
    rpc_write(client, &pHandle, sizeof(pHandle));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuIpcOpenEventHandle(void *args0) {
    ...
    rpc_write(client, &phEvent, sizeof(phEvent));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuArrayGetDescriptor_v2(void *args0) {
    ...
    rpc_write(client, &pArrayDescriptor, sizeof(pArrayDescriptor));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuMipmappedArrayGetLevel(void *args0) {
    ...
    rpc_write(client, &pLevelArray, sizeof(pLevelArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuMemBatchDecompressAsync(void *args0) {
    ...
    rpc_write(client, &paramsArray, sizeof(paramsArray));
    rpc_write(client, &errorIndex, sizeof(errorIndex));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuMemMapArrayAsync(void *args0) {
    ...
    rpc_write(client, &mapInfoList, sizeof(mapInfoList));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuMemGetAllocationGranularity(void *args0) {
    ...
    rpc_write(client, &granularity, sizeof(granularity));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuMemPoolExportPointer(void *args0) {
    ...
    rpc_write(client, &shareData_out, sizeof(shareData_out));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuStreamCreate(void *args0) {
    ...
    rpc_write(client, &phStream, sizeof(phStream));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuStreamGetCtx_v2(void *args0) {
    ...
    rpc_write(client, &pCtx, sizeof(pCtx));
    rpc_write(client, &pGreenCtx, sizeof(pGreenCtx));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuStreamEndCapture(void *args0) {
    ...
    rpc_write(client, &phGraph, sizeof(phGraph));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuStreamIsCapturing(void *args0) {
    ...
    rpc_write(client, &captureStatus, sizeof(captureStatus));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuEventElapsedTime(void *args0) {
    ...
    rpc_write(client, &pMilliseconds, sizeof(pMilliseconds));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuStreamBatchMemOp_v2(void *args0) {
    ...
    rpc_write(client, &paramArray, sizeof(paramArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphAddKernelNode_v2(void *args0) {
    ...
    rpc_write(client, &phGraphNode, sizeof(phGraphNode));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphBatchMemOpNodeGetParams(void *args0) {
    ...
    rpc_write(client, &nodeParams_out, sizeof(nodeParams_out));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphClone(void *args0) {
    ...
    rpc_write(client, &phGraphClone, sizeof(phGraphClone));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphNodeFindInClone(void *args0) {
    ...
    rpc_write(client, &phNode, sizeof(phNode));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphGetRootNodes(void *args0) {
    ...
    rpc_write(client, &rootNodes, sizeof(rootNodes));
    rpc_write(client, &numRootNodes, sizeof(numRootNodes));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphNodeGetDependentNodes(void *args0) {
    ...
    rpc_write(client, &dependentNodes, sizeof(dependentNodes));
    rpc_write(client, &numDependentNodes, sizeof(numDependentNodes));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphInstantiateWithFlags(void *args0) {
    ...
    rpc_write(client, &phGraphExec, sizeof(phGraphExec));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuOccupancyMaxPotentialBlockSize(void *args0) {
    ...
    rpc_write(client, &minGridSize, sizeof(minGridSize));
...
int handle_cuTexRefSetAddress_v2(void *args0) {
    ...
    rpc_write(client, &ByteOffset, sizeof(ByteOffset));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefSetBorderColor(void *args0) {
    ...
    rpc_write(client, &pBorderColor, sizeof(pBorderColor));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetArray(void *args0) {
    ...
    rpc_write(client, &phArray, sizeof(phArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetMipmappedArray(void *args0) {
    ...
    rpc_write(client, &phMipmappedArray, sizeof(phMipmappedArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetAddressMode(void *args0) {
    ...
    rpc_write(client, &pam, sizeof(pam));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetFilterMode(void *args0) {
    ...
    rpc_write(client, &pfm, sizeof(pfm));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetFormat(void *args0) {
    ...
    rpc_write(client, &pFormat, sizeof(pFormat));
    rpc_write(client, &pNumChannels, sizeof(pNumChannels));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetMipmapLevelBias(void *args0) {
    ...
    rpc_write(client, &pbias, sizeof(pbias));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetMipmapLevelClamp(void *args0) {
    ...
    rpc_write(client, &pminMipmapLevelClamp, sizeof(pminMipmapLevelClamp));
    rpc_write(client, &pmaxMipmapLevelClamp, sizeof(pmaxMipmapLevelClamp));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTexRefGetMaxAnisotropy(void *args0) {
    ...
    rpc_write(client, &pmaxAniso, sizeof(pmaxAniso));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuTensorMapEncodeTiled(void *args0) {
    ...
    rpc_write(client, &tensorMap, sizeof(tensorMap));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphicsSubResourceGetMappedArray(void *args0) {
    ...
    rpc_write(client, &pArray, sizeof(pArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGraphicsResourceGetMappedMipmappedArray(void *args0) {
    ...
    rpc_write(client, &pMipmappedArray, sizeof(pMipmappedArray));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGetProcAddress_v2(void *args0) {
    ...
    // PARAM void **pfn
    rpc_write(client, &symbolStatus, sizeof(symbolStatus));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuGreenCtxCreate(void *args0) {
    ...
    rpc_write(client, &phCtx, sizeof(phCtx));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuCtxFromGreenCtx(void *args0) {
    ...
    rpc_write(client, &pContext, sizeof(pContext));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDevSmResourceSplitByCount(void *args0) {
    ...
    rpc_write(client, &nbGroups, sizeof(nbGroups));
    rpc_write(client, &remaining, sizeof(remaining));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
...
int handle_cuDevResourceGenerateDesc(void *args0) {
    ...
    rpc_write(client, &phDesc, sizeof(phDesc));
    rpc_write(client, &resources, sizeof(resources));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
...
int handle_cuCheckpointProcessLock(void *args0) {
    ...
    rpc_write(client, &args, sizeof(args));
    rpc_write(client, &_result, sizeof(_result));
    if(rpc_submit_response(client) != 0) {
        std::cerr << "Failed to submit response" << std::endl;
        rtn = 1;
